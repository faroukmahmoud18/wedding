// public/js/data.js
// This file mimics sampleData.ts for client-side rendering in the static HTML/Blade conversion.
// In a real Laravel application, this data would come from the backend via Blade variables or API calls.
...
const sampleServices = [
  {
    id: '1',
    vendorId: '1',
    // vendor: sampleVendors[0], // In JS, we'll link this by ID or embed vendor name directly
    ...
    isActive: true,
    images: [
      { id: '1', serviceId: '1', path: 'https://placehold.co/600x400/D4AF37/303030?text=Royal+Photo+1', alt: 'Wedding ceremony photography', isPrimary: true },
      { id: '2', serviceId: '1', path: 'https://placehold.co/600x400/D4AF37/303030?text=Royal+Photo+2', alt: 'Bridal portraits', isPrimary: false },
    ],
  ...
  },
  {
    ...
    isActive: true,
    images: [
      { id: '3', serviceId: '2', path: 'https://placehold.co/600x400/C0C0C0/303030?text=Royal+Venue+1', alt: 'Garden ceremony setup', isPrimary: true, },
      { id: '4', serviceId: '2', path: 'https://placehold.co/600x400/C0C0C0/303030?text=Royal+Venue+2', alt: 'Reception ballroom', isPrimary: false, },
    ],
  ...
  },
  {
    ...
    isActive: true,
    images: [
      { id: 'i5', serviceId: 's3-dresses', path: 'https://placehold.co/600x400/FFC0CB/303030?text=Royal+Dress+1', alt: 'Designer wedding dress showcase', isPrimary: true, },
      { id: 'i6', serviceId: 's3-dresses', path: 'https://placehold.co/600x400/FFC0CB/303030?text=Royal+Dress+2', alt: 'Bridal fitting session', isPrimary: false, },
    ],
  ...
  },
  {
    ...
    isActive: true,
    images: [
      { id: 'i7', serviceId: 's4-makeup', path: 'https://placehold.co/600x400/FFDAB9/303030?text=Royal+Makeup+1', alt: 'Bridal makeup application', isPrimary: true,},
      { id: 'i8', serviceId: 's4-makeup', path: 'https://placehold.co/600x400/FFDAB9/303030?text=Royal+Makeup+2', alt: 'Bridal hairstyling', isPrimary: false,},
    ],
  ...
  // Add a few more for photography to test category page
   {
    id: 's5-photo',
    vendorId: '1',
    category: 'photography',
    title: 'Royal Engagement Session',
    slug: 'royal-engagement-session',
    shortDescription: 'Elegant 2-hour engagement photoshoot at a location of your choice.',
    longDescription: 'Celebrate your engagement with a stunning photoshoot by our expert photographers. This package includes a 2-hour session, multiple locations if desired, professional editing of 100+ images, and an online gallery.',
    priceFrom: 800,
    unit: 'session',
    isActive: true,
    images: [{ id: 'i9', path: 'https://placehold.co/600x400/D4AF37/FFFFFF?text=Engagement+Photo', alt: 'Couple engagement photo', isPrimary: true }],
    features: ['2-Hour Session', 'Choice of Location', '100+ Edited Photos', 'Online Gallery'],
    location: 'Beverly Hills, CA',
    rating: 4.8,
    reviewCount: 55,
    featured: false,
...
// Add vendor details to services for easier access in JS
sampleServices.forEach(service => {
    service.vendor = sampleVendors.find(v => v.id === service.vendorId);
});
...
const categoryConfig = {
  photography: {
    ...
    icon: '📸',
    gradient: 'from-purple-400 to-pink-400', // This gradient string is for reference, actual style applied in CSS/Blade
  },
  venues: {
...
// To make these available globally in other JS files if needed, though service-category.js will use them directly
// window.sampleServices = sampleServices;
// window.sampleVendors = sampleVendors;
// window.categoryConfig = categoryConfig;
console.log("data.js loaded: sampleServices, sampleVendors, categoryConfig are available.");
